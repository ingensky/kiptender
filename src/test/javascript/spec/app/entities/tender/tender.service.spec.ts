...
describe('Service Tests', () => {
  describe('Tender Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Tender(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false, false, false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Tender', async () => {
      ...
      it('should not update a Tender', async () => {
      ...
      it('should not return a list of Tender', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Tender', async () => {
