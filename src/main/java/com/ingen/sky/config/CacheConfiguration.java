...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ingen.sky.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ingen.sky.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.ingen.sky.domain.User.class.getName());
            createCache(cm, com.ingen.sky.domain.Authority.class.getName());
