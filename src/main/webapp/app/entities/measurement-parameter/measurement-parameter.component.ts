...
export default class MeasurementParameter extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllMeasurementParameters();
  }
  ...
  public retrieveAllMeasurementParameters(): void {
  ...
  public prepareRemove(instance: IMeasurementParameter): void {
  ...
  public removeMeasurementParameter(): void {
    this.measurementParameterService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('kiptenderApp.measurementParameter.deleted', { param: this.removeId });
