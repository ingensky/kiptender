...
export default class InstallationKIPiAGroup extends mixins(AlertMixin) {
  ...
  public mounted(): void {
    this.retrieveAllInstallationKIPiAGroups();
  }
  ...
  public retrieveAllInstallationKIPiAGroups(): void {
  ...
  public prepareRemove(instance: IInstallationKIPiAGroup): void {
  ...
  public removeInstallationKIPiAGroup(): void {
    this.installationKIPiAGroupService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('kiptenderApp.installationKIPiAGroup.deleted', { param: this.removeId });
